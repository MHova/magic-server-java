...
class GameTest {
	...
	void advanceStep() {
		...
		assertPlayer1HasPriority();
		retVal = classUnderTest.advanceStep();
		assertEquals(Pair.with(Players.PLAYER_1, Step.BEGINNING_OF_COMBAT),
				retVal);
		assertPlayer1HasPriority();
		retVal = classUnderTest.advanceStep();
		...
		assertPlayer1HasPriority();
		retVal = classUnderTest.advanceStep();
		assertEquals(Pair.with(Players.PLAYER_1, Step.FIRST_STRIKE_DAMAGE),
				retVal);
		assertPlayer1HasPriority();
		retVal = classUnderTest.advanceStep();
		...
		assertPlayer2HasPriority();
		retVal = classUnderTest.advanceStep();
		assertEquals(Pair.with(Players.PLAYER_2, Step.BEGINNING_OF_COMBAT),
				retVal);
		assertPlayer2HasPriority();
		retVal = classUnderTest.advanceStep();
		...
		assertPlayer2HasPriority();
		retVal = classUnderTest.advanceStep();
		assertEquals(Pair.with(Players.PLAYER_2, Step.FIRST_STRIKE_DAMAGE),
				retVal);
		assertPlayer2HasPriority();
		retVal = classUnderTest.advanceStep();
